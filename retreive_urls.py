...
example_link = 'https://carsandbids.com/past-auctions/'
...
def retrieve_urls(page_soup):
    ...
    listing_a_tags = listing_grid.find_all('a', {'href': re.compile('/auctions/')})
    listing_urls = set([a_tag['href'] for a_tag in listing_a_tags])
    return listing_urls
